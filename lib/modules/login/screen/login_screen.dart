...
class _LoginScreenState extends ModularState<LoginScreen, LoginController> {
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          GestureDetector(
            onTap: () async {
              Navigator.pushNamed(
                  context, LoginModule.initial + LoginModule.signUp);
            },
            child: Container(
  ...
  Future<void> _checkLogin() async {
    if (controller.isError) {
      AlertDialogs.showErrorDialog(
          context, S
          .of(context)
          .error_title, controller.errorMessage);
      ...
      AlertDialogs.showInfoDialog(
          context, S
          .of(context)
          .info_title, controller.errorMessage);
    } else {
  ...
  _forgotPassword() {
    AlertDialogs.showResetPassword(context, (email) async {
      ...
      if (controller.isError) {
        ...
        AlertDialogs.showSuccessDialog(context, S
            .of(context)
            .info_title,
            S
                .of(context)
  ...
  _signIn(UserModel currentUser) async {
